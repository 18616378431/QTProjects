...
QT_MOC_LITERAL(1, 15, 8), // "newValue"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 3), // "seq"
QT_MOC_LITERAL(4, 29, 9) // "diceValue"

    },
    "ThreadConsumer\0newValue\0\0seq\0diceValue"
};
...
void ThreadConsumer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThreadConsumer::newValue)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ThreadConsumer::newValue(int _t1, int _t2)
{
