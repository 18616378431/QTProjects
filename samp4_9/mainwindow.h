...
private slots:
    ...
    void on_btnResizeColumn_clicked();

    void on_btnResizeRow_clicked();
...
private:
    ...
    QLabel *labCellIndex;//状态栏上用于显示单元格行号列号
    QLabel *labCellType;//状态栏上同于显示单元格type
