...
void *QThreadProducer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QThreadProducer.stringdata0))
        return static_cast<void*>(const_cast< QThreadProducer*>(this));
...
QT_MOC_LITERAL(1, 16, 8), // "newValue"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 3), // "seq"
QT_MOC_LITERAL(4, 30, 9) // "diceValue"

    },
    "QThreadConsumer\0newValue\0\0seq\0diceValue"
};
#undef QT_MOC_LITERAL
...
void QThreadConsumer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QThreadConsumer::newValue)) {
                *result = 0;
                return;
            }
        }
...
void *QThreadConsumer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QThreadConsumer.stringdata0))
        return static_cast<void*>(const_cast< QThreadConsumer*>(this));
    return QThread::qt_metacast(_clname);
}
...
// SIGNAL 0
void QThreadConsumer::newValue(int _t1, int _t2)
{
